...
npx prisma generate --schema=install/database/schema.prisma

# Create a new migration (development)
npx prisma migrate dev --schema=install/database/schema.prisma

# Deploy migrations (production)
npx prisma migrate deploy --schema=install/database/schema.prisma

# View database
npx prisma studio --schema=install/database/schema.prisma
```
...
1. Migrations are deployed: `prisma migrate deploy --schema=install/database/schema.prisma`
2. Prisma client is generated: `prisma generate --schema=install/database/schema.prisma`

## Development

When making schema changes:

1. Edit `install/database/schema.prisma`
